...
describe('MarketplaceComponentComponent', () => {
  ...
  const mockArticles: ArticleMarket[] = [
    { name: 'Product 1', description: 'Description 1', quantity: 10, price: 100, brand: mockBrands, articleCategories: [{ id: 1, name: 'Category 1' }] },
    { name: 'Product 2', description: 'Description 2', quantity: 5, price: 200, brand: mockBrands, articleCategories: [{ id: 2, name: 'Category 2' }] }
  ];
